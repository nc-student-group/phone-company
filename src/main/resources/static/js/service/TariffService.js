...
angular.module('phone-company').factory('TariffService', ['$q', '$http', '$filter', function ($q, $http, $filter) {
    ...
    var GET_TARIFFS_BY_REGION = "api/tariffs/region/";
    ...
    var GET_TARIFF_BY_ID_URL = "api/tariffs/tariff/";
    ...
    function getTariffById(id) {
        var deferred = $q.defer();
        $http.get(GET_TARIFF_BY_ID_URL + id).then(
            function (response) {
                deferred.resolve(response.data);
            },
            function (errResponse) {
    ...
    function getTariffsForRegionPaged(id, page, size) {
        var deferred = $q.defer();
        $http.get(GET_TARIFFS_BY_REGION + id + "/" + page + "/" + size).then(
            function (response) {
                deferred.resolve(response.data);
            },
            function (errResponse) {
