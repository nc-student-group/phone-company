(function () {
    ...
    angular.module('phone-company')
        .controller('RepresentativeEditCustomerController', RepresentativeEditCustomerController);

    RepresentativeEditCustomerController.$inject = ['$routeParams','$scope', '$log', 'CustomerService', 'TariffService',
        'CorporationService', '$rootScope', '$mdDialog', '$location'];
    function RepresentativeEditCustomerController($routeParams,$scope, $log, CustomerService, TariffService,
                                     CorporationService, $rootScope, $mdDialog, $location) {
        console.log('This is RepresentativeEditCustomerController');
